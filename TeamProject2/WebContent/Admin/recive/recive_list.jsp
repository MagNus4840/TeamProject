...
<div class="contain">
	<div class="sub-topcontent">
		...
		<div class="sub-search">
			<form name="my" method="post" action="/Admin/recive/Recive_list.do" onsubmit="return check()">
				<select name="sel" class="sel">
					<option value="title">제품명</option>
					<option value="content">회사명</option>
					<option value="content">입고일</option>
					<option value="content">부품명</option>
				</select>
	...
	<div class="content-body">
		<table class="qatable">
			<caption class="readonly">입고</caption>
			<colgroup>
				<col width="10%">
				<col width="9%">
				<col width="20%">
